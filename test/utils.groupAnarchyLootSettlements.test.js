const groupAnarchyLootSettlements = require('../src/utils/groupAnarchyLootSettlements');

describe('groupAnarchyLootSettlements.js tests', () => {

  it('groupAnarchyLootSettlements return Should Match', async() => {
    ...
    // Act
    const actual = groupAnarchyLootSettlements(input);
